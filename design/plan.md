...
- **`Claim.broke` carries what was killed, rather than journaling from inside.** `claim.py` has no business knowing what a journal is, and step 12 is where a tend writes its other events.
