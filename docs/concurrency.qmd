...
Standing values belong in `_steward.md` front matter (`max_tasks`, `max_workers`, `samples_ramp`) or your definition (`max_samples`); the CLI is for the run where conditions differ.
