...
6. **Restore** logs the archive already holds for identifiers the new manifest asks for. A move rather than a re-run.
...
| **restore** | Asked for, and a log for it is sitting in the archive. | yes |
